...
class Test(TestCase):
    ...
    def test_complete_scenario(self):
        self.path_utils.add_folders_to_path(dirname='folder')
        ...
        self.pylint2.run_pylint(dirname='folder', out_file='pylint2_old.txt')

        self.assertGreater(os.path.getsize('pylint2_old.txt'), 0)

        self.futurize.run_futurize('folder')

        self.pylint2.run_pylint(dirname='folder', out_file='pylint2_new.txt')
        ...
        self.pylint3.run_pylint(dirname='folder', out_file='pylint3_new.txt')
